...
if branch == 'micro_throughput':
    ...
    rects1 = ax.bar(eRPC_ticks, tp_group * scale, color=blue, width=colomn_width, edgecolor=black, label='Throughput', hatch='//')
    ...
    rects2 = ax.bar(OvS_ticks, tp_group * scale, color=blue, width=colomn_width, edgecolor=black, hatch='//')
    ...
    rects3 = ax.bar(LineFS_ticks, tp_group * scale, color=blue, width=colomn_width, edgecolor=black, hatch='//')
    ...
    rects4 = ax.bar(ACCLIO_ticks, tp_group * scale, color=blue, width=colomn_width, edgecolor=black, hatch='//')
    ...
    throughput_legend = Patch(facecolor='white', edgecolor='black', label='Throughput', hatch='//')
    line_rate_legend = Patch(facecolor='white', edgecolor='black', linestyle='dashed', label='Line-rate Thrpt')
    
    # 重新排序handles和labels
    ordered_handles = [line_rate_legend, throughput_legend] + handles1[2:]
    ordered_labels = ['Line-rate Thrpt', 'Throughput'] + labels1[2:]
...
if output == 'show':
    ...
    plt.savefig(output_path + branch + '.pdf', bbox_inches='tight')