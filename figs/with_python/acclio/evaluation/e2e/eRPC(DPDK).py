...
if branch == 'eRPC(DPDK)':
    ...
    tp_group = np.array([37.981, 51.939, 65.574, 77.181])
    # 设置不同方案的颜色
    ...
    cache_miss_group = np.array([72, 51, 7, 2])
    ...
    tp_group = np.array([25.154, 27.839, 32.385, 43.065])
    ...
    cache_miss_group = np.array([69, 46, 7, 3])
    ...
    tp_group = np.array([16.094, 16.872, 18.186, 21.708])
    ...
    cache_miss_group = np.array([46, 33, 6, 2])
