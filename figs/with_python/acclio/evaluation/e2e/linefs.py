...
if branch == 'linefs':
    ...
    tp_group = np.array([21.473, 26.481, 29.099, 36.417])
    ...
    cache_miss_group = np.array([88, 52, 19, 13])
    ...
    tp_group = np.array([16.343, 19.536, 24.563, 29.749])
    ...
    cache_miss_group = np.array([71, 47, 18, 11])
    ...
    tp_group = np.array([14.336, 16.982, 18.704, 21.678])
    ...
    cache_miss_group = np.array([40, 25, 10, 6])
