...
branch = 'change_distribution' # ['burst', 'change_distribution']
...
thpt_exp = [79.5]*10 + [60.5]*10 + [41.2]*10 + [21.2]*10 + [11.8]*10   # HostCC吞吐量 (mpps)
# 绘制图形
...
# 图例
plt.legend(loc="upper center", bbox_to_anchor=(0.5, 1.15),  # 调整图例位置
              ncol=4,                      # 图例列数
              fontsize=12,                 # 字体大小
              frameon=False)
...
# 手动设置 y 轴范围，确保显示 0 到 85
plt.ylim(0, 85)  # 修改y轴上限为85
